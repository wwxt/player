<template>
	...
	<el-row>
		<el-col :span="24">
			...
			<video  id="myVideo" autoplay="autoplay" controls class="video-js" width="100%" height="100%"  object-fit="fill" >
	...
	<el-row>
		<el-col  :span="22" :offset="1">
			<div class="inco box" >
				...
				<div class="tile"><span class="title lf">{{dataitemList.author.name}}</span>
 ...
 <el-divider></el-divider>
		...
		<div class="null">
			<div class="end"><i class="el-icon-loading"></i><p class="p2">加载完毕</p></div>
		</div>
	</div>
</template>
